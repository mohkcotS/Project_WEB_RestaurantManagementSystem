...
export const BestSellingTable = ({bestSelling}) => {
    return (
        <div className="flex flex-col  items-center w-[30%] border-2 border-gray-200 rounded-3xl 
            ...
            <h1 className="text-center text-lg font-bold mb-2 text-yellow-600">Best-selling Dishes Today</h1>
            <hr className="w-full border-white" />

            <div className="w-full flex flex-col py-2 text-sm font-semibold">
