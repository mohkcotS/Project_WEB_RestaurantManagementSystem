export const ManagerPaymentCard = ({ payment,  setSelectedPayment , setOpenEdit }) => {
    ...
    return (
        <div className="w-full grid grid-cols-7  text-white text-xl place-items-center
                        bg-white/20 py-4 items-center rounded-2xl text-center mb-3 hover:scale-105 duration-500">
            <h1 className="font-bold text-2xl ">{payment.id}</h1>
            <h1 className="font-bold text-2xl">{payment.OrderId}</h1>
            <h1 >{payment.date}</h1>
