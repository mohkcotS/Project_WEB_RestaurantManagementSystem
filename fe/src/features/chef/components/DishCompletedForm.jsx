...
export const DishCompletedForm = ({setOpenDishCompleted, setNotification, selectedDish, fetchOrderDishes,id}) => {
    ...
    return (
        <div className='w-[400px] h-auto rounded-3xl bg-gray-100 p-6 space-y-6'>
            ...
            <div className="flex flex-col items-center gap-5">
                <h2 className="font-bold text-center text-lg"> Is this dish completed and ready to serve? </h2>
                <div className="flex gap-20">
                    <button 
                    onClick={()=>{handleCompleteDish()}}
                    className="rounded-xl hover:cursor-pointer text-sm bg-green-500  hover:scale-105 active:scale-95 duration-300 text-white font-bold px-8 py-2 ">Yes</button>
                
                <button onClick={() => setOpenDishCompleted(false)} className="rounded-xl text-sm hover:cursor-pointer bg-red-500  hover:scale-105 active:scale-95 duration-300 text-white font-bold px-8 py-2 ">No</button>
                </div>
