...
export const CustomerOrderCard = ({order ,cart,setCart}) => {
    ...
    return (
        <div className="w-full h-[50px] grid grid-cols-[5fr_2fr_3fr] gap-5 text-white items-center justify-center border-b-1 border-gray-500/80">
            ...
            <h1 className=" text-lg w-48 truncate" title={order.dish.name}>{order.dish.name}</h1>
            
            <h1 className=" text-md ">${order.dish.price}</h1>
            ...
            <div className=" flex gap-5 text-white justify-center">
                ...
                <h1 className="text-lg font-bold">{order.quantity}</h1>
                <button
