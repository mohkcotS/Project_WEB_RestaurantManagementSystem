...
export const CustomerOrderCard1 = ({order, setOpenSeeDetail, setSelectedOrder}) => {
    ...
    return (
        <div className="w-full grid grid-cols-5 place-items-center text-white text-xl
            ...
            className="max-w-[150px] px-6 py-2 border-2 border-gray-500 rounded-xl text-lg hover:cursor-pointer  
