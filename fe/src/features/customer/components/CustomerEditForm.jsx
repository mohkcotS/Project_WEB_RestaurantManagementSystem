...
export const CustomerEditForm = ({ editId, setOpenEdit, setNotification, getUserInformation }) => {
    ...
    return (
        <div className=' relative w-[500px] h-auto rounded-3xl border-3 bg-gray-100 p-6 space-y-6 shadow-lg'>
            <div className="grid grid-cols-2 pt-8 items-center text-xl font-bold ">
                <div
            ...
            {!changePassword && <div className='flex flex-col gap-y-4 gap-x-6'>
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-lg font-bold text-blue-900">Phone Number</h1>
                    <input
                        className='px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-400'
                        type="text"
                ...
                <div className="grid grid-cols-2 gap-x-5">
                    <button
                        ...
                        className="px-4 py-2 border-2 border-gray-300 rounded-xl text-lg hover:cursor-pointer hover:border-green-700
                    transition-all duration-500 hover:scale-105 active:scale-95 text-green-700 font-bold">Save Change</button>
                    <button
                        onClick={()=>{setOpenDelete(true)}}
                        className="px-4 py-2 border-2 border-gray-300 rounded-xl text-lg hover:cursor-pointer hover:border-red-700
            ...
            {changePassword && <div  className='flex flex-col gap-y-4 gap-x-6'>
                <div className="flex flex-col gap-2">
                    <h1 className="text-lg font-bold text-blue-900">Old Password</h1>
                    <input
                        className='px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-400'
                        type="password"
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-lg font-bold text-blue-900">New Password</h1>
                    <input
                        className='px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-400'
                        type="password"
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-lg font-bold text-blue-900">Confirmed Password</h1>
                    <input
                        className='px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-400'
                        type="password"
